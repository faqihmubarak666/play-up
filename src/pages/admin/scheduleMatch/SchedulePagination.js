...
const SchedulePagination = (props) => {
  ...
  prevPage =
    page !== 1 ? (
      <Pagination.Prev onClick={() => onSetPage(Number(page - 1))} />
    ) : (
  ...
  nextPage =
    page < lastPage ? (
      <Pagination.Next onClick={() => onSetPage(Number(page + 1))} />
    ) : (
  ...
  pageMinusOne =
    page !== 1 ? (
      <Pagination.Item onClick={() => onSetPage(Number(page - 1))}>
        {page - 1}
      </Pagination.Item>
    ) : (
      ""
  ...
  pageMinusTwo =
    page !== 1 && page !== 2 ? (
      <Pagination.Item onClick={() => onSetPage(Number(page - 2))}>
        {page - 2}
      </Pagination.Item>
    ) : (
      ""
